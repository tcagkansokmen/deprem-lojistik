...
Route::post('/save', 'App\Http\Controllers\HomepageController@save')->name('vehicle-form');
Route::post('/save-update', 'App\Http\Controllers\HomepageController@saveUpdate')->name('vehicle-form-save');
